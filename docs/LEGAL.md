...
- Hosting: Cloud Run frontend (`accessible-web`) plus optional Cloud Run/OCR backends. Keep secrets in environment variables; avoid embedding keys in client code.
