...
- Environment: set `DATABASE_URL` (Postgres) and keep it out of VCS/Netlify logs. Netlify functions should use the Cloud Run/connector-based API, not direct DB.
...
- ✅ Braille prototype documented with env toggles and UI path.
